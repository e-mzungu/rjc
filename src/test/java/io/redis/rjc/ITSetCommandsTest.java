...
public class ITSetCommandsTest extends SingleNodeTestBase {
    ...
    public void srem() {
        ...
        assertEquals(1, status);
        assertEquals(expected, session.smembers("foo"));
    ...
    public void spop() {
        ...
        assertEquals(1, session.smembers("foo").size());
    ...
    public void smove() {
        ...
        assertEquals(expectedSrc, session.smembers("foo"));
        assertEquals(expectedDst, session.smembers("bar"));
    ...
    public void sinterstore() {
        ...
        assertEquals(expected, session.smembers("car"));
    }
    ...
    public void srandmember() {
        ...
        assertTrue("a".equals(member) || "b".equals(member));
        assertEquals(2, session.smembers("foo").size());
